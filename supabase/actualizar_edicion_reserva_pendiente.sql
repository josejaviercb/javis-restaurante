-- =====================================================================
-- Javi's — Actualización: solo se edita una reserva pendiente
-- Ejecutar en Supabase (SQL Editor). Es seguro ejecutarlo varias veces.
--
-- Qué hace:
--   - Un cliente puede seguir CANCELANDO una reserva pendiente o
--     confirmada (como hasta ahora).
--   - Un cliente solo puede EDITAR (fecha, franja, personas, contacto,
--     notas) mientras la reserva siga en estado 'pendiente'.
--   - El administrador conserva control total sobre cualquier estado.
-- =====================================================================
